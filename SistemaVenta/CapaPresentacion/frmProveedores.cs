...
namespace CapaPresentacion
{
    public partial class frmProveedores: Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debes seleccionar un proveedor para eliminar", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteProveedor_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
